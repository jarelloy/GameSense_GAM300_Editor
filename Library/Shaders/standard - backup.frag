...
void main() 
{
    ...
    {        
        ...
        vec4 LocalSpaceLightPos = In.inverse_model * vec4(uniforms.light_source_list[i].position, 1.0);
        ...
        vec4 LocalSpaceEyePos = In.inverse_model * vec4(pushConsts.world_eye_pos.xyz, 1.0);
